function org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset(){
  var $wnd_0 = window;
  var $doc_0 = document;
  sendStats('bootstrap', 'begin');
  function isHostedMode(){
    var query = $wnd_0.location.search;
    return query.indexOf('gwt.codesvr.org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset=') != -1 || query.indexOf('gwt.codesvr=') != -1;
  }

  function sendStats(evtGroupString, typeString){
    if ($wnd_0.__gwtStatsEvent) {
      $wnd_0.__gwtStatsEvent({moduleName:'org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset', sessionId:$wnd_0.__gwtStatsSessionId, subSystem:'startup', evtGroup:evtGroupString, millis:(new Date).getTime(), type:typeString});
    }
  }

  org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__sendStats = sendStats;
  org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__moduleName = 'org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset';
  org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__errFn = null;
  org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__moduleBase = 'DUMMY';
  ...
  ;
  org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  function setupInstallLocation(){
    ...
    scriptFrame.id = 'org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset';
  ...
  function processMetas(){
    ...
    for (var i = 0, n = metas.length; i < n; ++i) {
      ...
      if (name_1) {
        name_1 = name_1.replace('org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset::', '');
        if (name_1.indexOf('::') >= 0) {
          continue;
        }
    ...
    org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__errFn = onLoadErrorFunc;
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset.nocache.js') != -1) {
  ...
  function computeUrlForResource(resource){
    ...
    return org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__getPropMap = function(){
      var result = {};
    ...
    ;
    org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__computePropValue = computePropValue;
    $wnd_0.__gwt_activeModules['org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset'].bindings = org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__getPropMap;
    sendStats('bootstrap', 'selectingPermutation');
    if (isHostedMode()) {
      return computeUrlForResource('org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset.devmode.js');
    }
    var strongName;
    try {
    ...
    org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__softPermutationId = softPermutationId;
  ...
  processMetas();
  org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__moduleBase = computeScriptBase();
  activeModules['org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset'].moduleBase = org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.__moduleBase;
  var filename_0 = getCompiledCodeFilename();
  if ($wnd_0) {
    var devModePermitted = !!($wnd_0.location.protocol == 'http:' || $wnd_0.location.protocol == 'file:');
    $wnd_0.__gwt_activeModules['org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset'].canRedirect = devModePermitted;
    ...
    if (devModePermitted && supportsSessionStorage()) {
      var devModeKey = '__gwtDevModeHook:org.semanticsoft.vaaclipse.widgetset.DefaultWidgetset';
...
org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset.succeeded = org_semanticsoft_vaaclipse_widgetset_DefaultWidgetset();
